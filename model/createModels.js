...
// ]
// const directions_4 = ['In a large bowl, combine yogurt, lemon juice, 2 teaspoons cumin, cinnamon, cayenne, black pepper, ginger, and salt. Stir in chicken, cover, and refrigerate for 1 hour.',
...
//
//
// var Item_DB = new ItemDb([item_1,item_2,item_3,item_4,item_5,item_6,item_7,item_8,item_9,item_10,item_11,item_12]);
//
// var user_1 = new user('U001','abcdef','John','Doe','jdoe@gmail.com','9876 Rochester park','Downs street','Charlotte','North Carolina','254789','Mcklenberg');
// var user_2 = new user('U002','uvwxyz','Rachel','Doe','rdoe@gmail.com','9876 Rochester park','Downs street','Charlotte','North Carolina','254789','Mcklenberg');
//
// var user_item_1 = new userItem('A001',5,true);
// var user_item_2 = new userItem('A002',4,false);
// var user_item_3 = new userItem('A003',3,true);
// var user_item_4 = new userItem('A004',4,false);
// var user_item_5 = new userItem('M001',2,true);
// var user_item_6 = new userItem('M002',2,true);
// var user_item_7 = new userItem('M003',2,false);
// var user_item_8 = new userItem('M004',2,true);
// var user_item_9 = new userItem('M005',2,true);
// var user_item_10 = new userItem('M006',2,false);
// var user_item_11 = new userItem('M007',2,true);
// var user_item_12 = new userItem('M008',2,true);
//
...
// });*/
// let user_item_13 = new userItem('A005',5,true,'Appetizer','Indian Curry');
// let user_p_list = user_DB.getuser_profile();
// let u_profile = user_p_list[0];
// u_profile.addItem();
// //u_profile.removeItem('A001');
// let user_item_14 = new userItem('A001',10,true);
...
// console.log('User Item Code: '+ user_item_list.getUserItem());
...
//
//
// /*const list = Item_DB.getItems();
// list.forEach(function (item) {
//     console.log('For Item  '+item.getItemName());
//     console.log('Item Code:  '+ item.getItemCode());
//     console.log('Category:' + item.getCatalog());
//     console.log('Description: '+item.getDescription());
//     console.log('Rating: '+item.getRating());
//     console.log('Image Url  -->'+ Item.getImageUrl(item.getItemCode()));
// });*/
// /*console.log('.........getCategories()..............');
// var c_list = Item_DB.getCategories();
// c_list.forEach(function (item) {
//         let ci_list = Item_DB.getItemsOfParticularCategory(item);
//     console.log('.........getItemsOfParticularCategories()..............');
//         ci_list.forEach(function (citem) {
//             console.log('For Item  '+citem.getItemName());
//             console.log('Item Code:  '+ citem.getItemCode());
//             console.log('Category:' + citem.getCatalog());
//             console.log('Description: '+citem.getDescription());
//             console.log('Rating: '+citem.getRating());
//             console.log('Image Url  -->'+ Item.getImageUrl(citem.getItemCode()));
//             console.log('User:' +citem.getUser());
//         });
// });
// */
//
// // let obj = Item_DB.getItem('A001');
